...
phase_begin("ma10", "Construct PSIS/LOO secondary DA")
ensure_analysis_dirs()
validate_final_analysis_config("ma10 PSIS/LOO secondary DA", final_mode = TRUE)

script_name <- "scripts/ma10_construct_psis_loo_DA.R"
