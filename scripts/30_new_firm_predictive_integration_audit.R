...
note <- c(
  ...
  "",
  "Verification is not global. Evidence from `scripts/28_row_level_exact_kfold.R` can verify only row-level K-fold new-level scoring behavior; it does not verify posterior predictive tail draws created by `scripts/10_construct_uncertainty_adjusted_DA.R`.",
  "",
  "Stacked DA predictive/tail quantities are matched to `scripts/10_construct_uncertainty_adjusted_DA.R`. In strict mode, ambiguous stacked predictive/tail columns are treated as potentially Firm-RE out-of-firm quantities and require source-specific u_new verification.",
  "",
  "## Decision",
  "",
