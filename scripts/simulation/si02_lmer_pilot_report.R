...
phase_begin("si02", "Simulation: LMER pilot report")
...
if (!file.exists(rep_path)) stop("[BLOCKER] Run scripts/simulation/si01_lmer_pilot_run.R first.")
...
phase_end("si02", "Simulation: LMER pilot report")
