...
phase_begin("se03", "Sensitivity MCMC diagnostics")
ensure_analysis_dirs()
ensure_sensitivity_dirs()
validate_final_analysis_config("se03 sensitivity diagnostics", final_mode = TRUE)
...
phase_end("se03", "Sensitivity MCMC diagnostics")
