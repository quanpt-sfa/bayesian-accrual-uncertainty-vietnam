...
phase_begin("se02", "Sensitivity refit prior scenarios")
ensure_analysis_dirs()
ensure_sensitivity_dirs()
validate_final_analysis_config("se02 sensitivity refit", final_mode = TRUE)
...
phase_end("se02", "Sensitivity refit prior scenarios")
