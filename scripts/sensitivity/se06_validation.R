...
phase_begin("se06", "Sensitivity validation")
ensure_analysis_dirs()
ensure_sensitivity_dirs()
validate_final_analysis_config("se06 sensitivity validation", final_mode = TRUE)
...
phase_end("se06", "Sensitivity validation")
