...
# Standalone simulation profile. Requires a completed main run marker.
...
$consoleLog = "$RunRoot/logs/simulation_after_main_10w4c_$timestamp.log"

Write-Host "Branch      : simulation"
